...
def Read_Histogram_pkl(file, reweighting_var, reweighting_factor):
    ...
    if reweighting_factor == 'none':
        return_hist = hists[f"{weight_option_map[reweighting_factor]}"]
    else:
        return_hist = hists[f"{var_map[reweighting_var]}_{weight_option_map[reweighting_factor]}"]
    return return_hist
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path-mc', help='The path to the MC histogram file(.pkl file).')
    parser.add_argument('--path-data', help='The path to the Data histogram file(.pkl file).')
